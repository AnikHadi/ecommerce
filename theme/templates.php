...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +880 163 404 2603</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> hadiuzzamananik9@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                <li><a target=blank_ href="https://web.facebook.com/profile.php?id=100007583715889"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a target=blank_ href="https://www.linkedin.com/in/md-hadiuzzaman-938122209/"><i class="fa fa-linkedin"></i></a></li>
                <li><a href="#"><i class="fa fa-dribbble"></i></a></li>
                <li><a target=blank_ href="https://github.com/HadiAnik"><i class="fa fa-github"></i></a></li>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Time zone in Dhaka (GMT+6), BD(Dhaka)</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p>MD Hadiuzzaman (何漫), Student ID: 20183290509, Yunnan University, Yunnan, China</p>
        <div class="row">
          <div class="col-sm-3">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="#">Hadiuzzaman</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="#">Hadiuzzaman</a></span></p>
        </div>
      </div>
    </div>
